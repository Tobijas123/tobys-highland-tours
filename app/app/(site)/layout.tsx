      ...
      <body style={{ margin: 0 }}>
        <style>{`
          :root{
            ...
            /* Highland tones */
            --navy:#071a34;     /* trust / depth */
            --moss:#275548;     /* nature / calm */
            --heather:#5b4b8a;  /* premium accent */
            ...
            --ring: 0 0 0 3px rgba(201,162,39,.22);
          }
          ...
          html,body{
            ...
            background:
              ...
              linear-gradient(180deg, rgba(255,255,255,.78), var(--bg));
          }
          ...
          .card{
            ...
            border-radius: 16px;
            box-shadow: 0 22px 65px rgba(11,31,58,.18);
            transition: transform 180ms ease, box-shadow 180ms ease, border-color 180ms ease, outline 180ms ease;
          }
          .card:hover{
            transform: translateY(-4px);
            border-color: rgba(91,75,138,.38);
            box-shadow: 0 30px 95px rgba(11,31,58,.24);
          ...
          .tourMedia::after{
            ...
            position:absolute;
            inset:0;
            background: linear-gradient(180deg, rgba(0,0,0,0) 45%, rgba(11,31,58,.28));
            pointer-events:none;
          }
