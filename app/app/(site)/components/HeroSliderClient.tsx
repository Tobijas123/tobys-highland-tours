  ...
  const FALLBACK_SLIDES: Slide[] = [
    {
      ...
      heading: t('hero.title', lang),
      subheading: t('hero.subtitle', lang),
    },
    {
      ...
      >
        <div className="heroContent">
          ...
          <h1 className="heroTitle" style={{ maxWidth: 700, lineHeight: 1.15 }}>
            {slide.heading || t('hero.title', lang)}
          ...
          <p className="heroSubtitle" style={{ maxWidth: 500 }}>
            {slide.subheading || t('hero.subtitle', lang)}
          </p>

          <div className="heroTrust">
            <a href="#" className="heroTrustReviews">
              <span className="heroStars">★★★★★</span>
              <span>{t('hero.reviews', lang)}</span>
            </a>
            <div className="heroTrustChips">
              <span className="heroChip">{t('hero.chip.localGuide', lang)}</span>
              <span className="heroChip">{t('hero.chip.privateTours', lang)}</span>
              <span className="heroChip">{t('hero.chip.flexibleStops', lang)}</span>
              <span className="heroChip">{t('hero.chip.people', lang)}</span>
            </div>
          </div>
