      ...
      >
        <div className="heroContent">
          ...
          <p className="heroSubtitle" style={{ maxWidth: 500 }}>
            {slide.subheading || t('hero.subtitle')}
          </p>
          ...
          <div className="heroTrust">
            ...
            <div className="heroTrustChips">
              <span className="heroChip">{t('hero.chip.localGuide')}</span>
              <span className="heroChip">{t('hero.chip.privateTours')}</span>
              <span className="heroChip">{t('hero.chip.flexibleStops')}</span>
              <span className="heroChip">{t('hero.chip.people')}</span>
            </div>
          </div>
